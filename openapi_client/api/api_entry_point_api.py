...
class APIEntryPointApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.retrieve_api_resources_endpoint = _Endpoint(
            settings={
                'response_type': (RetrieveApiResourcesResponse,),
                'auth': [],
                'endpoint_path': '/v2',
                'operation_id': 'retrieve_api_resources',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def retrieve_api_resources(
        ...
        **kwargs
        ...
        return self.retrieve_api_resources_endpoint.call_with_http_info(**kwargs)
