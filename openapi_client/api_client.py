...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = APIEntryPointApi()
        api_instance.retrieve_api_resources  # this is an instance of the class Endpoint
        api_instance.retrieve_api_resources()  # this invokes api_instance.retrieve_api_resources.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.retrieve_api_resources.callable or self.callable in this class
