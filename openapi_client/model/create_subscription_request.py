...
class CreateSubscriptionRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, subject, notification, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            throttling (int): . [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, subject, notification, *args, **kwargs):  # noqa: E501
        """CreateSubscriptionRequest - a model defined in OpenAPI
