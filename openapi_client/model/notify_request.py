...
class NotifyRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, subscription_id, data, *args, **kwargs):  # noqa: E501
        """NotifyRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, subscription_id, data, *args, **kwargs):  # noqa: E501
        """NotifyRequest - a model defined in OpenAPI
